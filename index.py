...
class PersistentParticle():
    ...
    def get_pos(self, i):
        ...
        y_pos = a[i] * np.cos(t) + b[i] * np.cos(2*t) + \
            c[i] * np.cos(3*t) + d[i] * np.cos(4*t)
...
for repeat in range(3):
    for t in np.concatenate((np.linspace(0.18, 3.14-0.18, 890), np.linspace(3.14+0.18, 2*3.1415-0.18, 890)), axis=0):
...
for repeat in range(3):
    for t in np.concatenate((np.linspace(0.2, 3.14-0.2, 345), np.linspace(3.14+0.2, 2*3.1415-0.2, 345)), axis=0):
